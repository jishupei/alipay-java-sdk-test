 ...
 */
public class AlipayOpenAuthAppAesGetRequest implements AlipayRequest<AlipayOpenAuthAppAesGetResponse> {
	...
	* 授权应用aes密钥查询
	...
	public Class<AlipayOpenAuthAppAesGetResponse> getResponseClass() {
		return AlipayOpenAuthAppAesGetResponse.class;
	}
