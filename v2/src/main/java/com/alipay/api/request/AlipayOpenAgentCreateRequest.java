 ...
 */
public class AlipayOpenAgentCreateRequest implements AlipayRequest<AlipayOpenAgentCreateResponse> {
	...
	* 开启带商户签约、创建应用事务
	...
	public Class<AlipayOpenAgentCreateResponse> getResponseClass() {
		return AlipayOpenAgentCreateResponse.class;
	}
