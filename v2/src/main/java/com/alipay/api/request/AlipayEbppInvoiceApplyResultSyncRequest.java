 ...
 */
public class AlipayEbppInvoiceApplyResultSyncRequest implements AlipayRequest<AlipayEbppInvoiceApplyResultSyncResponse> {
	...
	* 同步发票申请结果
	...
	public Class<AlipayEbppInvoiceApplyResultSyncResponse> getResponseClass() {
		return AlipayEbppInvoiceApplyResultSyncResponse.class;
	}
