...
import com.alipay.api.domain.AlipayEbppPdeductAsyncPayModel;
...
public class AlipayEbppPdeductAsyncPayRequest implements AlipayRequest<AlipayEbppPdeductAsyncPayResponse> {
	...
	* 公共事业缴费直连代扣异步扣款支付接口
	...
	public Class<AlipayEbppPdeductAsyncPayResponse> getResponseClass() {
		return AlipayEbppPdeductAsyncPayResponse.class;
	}
