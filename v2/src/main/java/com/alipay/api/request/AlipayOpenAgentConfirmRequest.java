 ...
 */
public class AlipayOpenAgentConfirmRequest implements AlipayRequest<AlipayOpenAgentConfirmResponse> {
	...
	* 提交代商户签约、创建应用事务
	...
	public Class<AlipayOpenAgentConfirmResponse> getResponseClass() {
		return AlipayOpenAgentConfirmResponse.class;
	}
