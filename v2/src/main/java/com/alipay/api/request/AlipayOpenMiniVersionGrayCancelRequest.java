...
import com.alipay.api.domain.AlipayOpenMiniVersionGrayCancelModel;
...
public class AlipayOpenMiniVersionGrayCancelRequest implements AlipayRequest<AlipayOpenMiniVersionGrayCancelResponse> {
	...
	* 小程序结束灰度
	...
	public Class<AlipayOpenMiniVersionGrayCancelResponse> getResponseClass() {
		return AlipayOpenMiniVersionGrayCancelResponse.class;
	}
