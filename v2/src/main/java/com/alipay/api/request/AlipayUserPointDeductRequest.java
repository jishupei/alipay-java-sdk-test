...
import com.alipay.api.domain.AlipayUserPointDeductModel;
...
public class AlipayUserPointDeductRequest implements AlipayRequest<AlipayUserPointDeductResponse> {
	...
	* 蚂蚁会员积分扣减接口（需要用户授权）
	...
	public Class<AlipayUserPointDeductResponse> getResponseClass() {
		return AlipayUserPointDeductResponse.class;
	}
