...
import com.alipay.api.domain.AlipayUserTwostageCommonUseModel;
...
public class AlipayUserTwostageCommonUseRequest implements AlipayRequest<AlipayUserTwostageCommonUseResponse> {
	...
	* 通用当面付二阶段接口
	...
	public Class<AlipayUserTwostageCommonUseResponse> getResponseClass() {
		return AlipayUserTwostageCommonUseResponse.class;
	}
