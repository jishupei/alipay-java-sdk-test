...
import com.alipay.api.response.AliosOpenAutoInfoQueryResponse;
...
public class AliosOpenAutoInfoQueryRequest implements AlipayRequest<AliosOpenAutoInfoQueryResponse> {
	...
	* 查询阿里车的车辆信息
	...
	public Class<AliosOpenAutoInfoQueryResponse> getResponseClass() {
		return AliosOpenAutoInfoQueryResponse.class;
	}
