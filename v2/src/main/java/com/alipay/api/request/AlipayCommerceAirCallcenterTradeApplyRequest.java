 ...
 */
public class AlipayCommerceAirCallcenterTradeApplyRequest implements AlipayRequest<AlipayCommerceAirCallcenterTradeApplyResponse> {
	...
	* 航司电话订票待申请接口
	...
	public Class<AlipayCommerceAirCallcenterTradeApplyResponse> getResponseClass() {
		return AlipayCommerceAirCallcenterTradeApplyResponse.class;
	}
