...
import com.alipay.api.domain.AlipayUserAgreementExecutionplanModifyModel;
...
public class AlipayUserAgreementExecutionplanModifyRequest implements AlipayRequest<AlipayUserAgreementExecutionplanModifyResponse> {
	...
	* 周期性扣款协议执行计划修改接口
	...
	public Class<AlipayUserAgreementExecutionplanModifyResponse> getResponseClass() {
		return AlipayUserAgreementExecutionplanModifyResponse.class;
	}
