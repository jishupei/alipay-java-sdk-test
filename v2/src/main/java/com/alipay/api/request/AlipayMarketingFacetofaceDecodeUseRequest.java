...
import com.alipay.api.domain.AlipayMarketingFacetofaceDecodeUseModel;
...
public class AlipayMarketingFacetofaceDecodeUseRequest implements AlipayRequest<AlipayMarketingFacetofaceDecodeUseResponse> {
	...
	* 开发当面付付款码解码
	...
	public Class<AlipayMarketingFacetofaceDecodeUseResponse> getResponseClass() {
		return AlipayMarketingFacetofaceDecodeUseResponse.class;
	}
