 ...
 */
public class AlipayOpenMiniExperienceQueryRequest implements AlipayRequest<AlipayOpenMiniExperienceQueryResponse> {
	...
	* 小程序体验版轮询接口
	...
	public Class<AlipayOpenMiniExperienceQueryResponse> getResponseClass() {
		return AlipayOpenMiniExperienceQueryResponse.class;
	}
