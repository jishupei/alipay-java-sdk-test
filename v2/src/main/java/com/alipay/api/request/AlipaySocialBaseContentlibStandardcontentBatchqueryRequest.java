...
public class AlipaySocialBaseContentlibStandardcontentBatchqueryRequest implements AlipayRequest<AlipaySocialBaseContentlibStandardcontentBatchqueryResponse> {
	...
	* 内容批量查询接口
	...
	public Class<AlipaySocialBaseContentlibStandardcontentBatchqueryResponse> getResponseClass() {
		return AlipaySocialBaseContentlibStandardcontentBatchqueryResponse.class;
	}
