...
import com.alipay.api.domain.AlipayOpenAgentSignstatusQueryModel;
...
public class AlipayOpenAgentSignstatusQueryRequest implements AlipayRequest<AlipayOpenAgentSignstatusQueryResponse> {
	...
	* isv查询商户某个产品的签约状态
	...
	public Class<AlipayOpenAgentSignstatusQueryResponse> getResponseClass() {
		return AlipayOpenAgentSignstatusQueryResponse.class;
	}
