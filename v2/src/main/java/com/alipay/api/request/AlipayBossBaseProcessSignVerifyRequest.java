...
import com.alipay.api.response.AlipayBossBaseProcessSignVerifyResponse;
...
public class AlipayBossBaseProcessSignVerifyRequest implements AlipayRequest<AlipayBossBaseProcessSignVerifyResponse> {
	...
	* 核实流程签名
	...
	public Class<AlipayBossBaseProcessSignVerifyResponse> getResponseClass() {
		return AlipayBossBaseProcessSignVerifyResponse.class;
	}
