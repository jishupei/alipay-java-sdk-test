...
import com.alipay.api.response.AlipayCommerceEducateXuexinIdentityQueryResponse;
...
public class AlipayCommerceEducateXuexinIdentityQueryRequest implements AlipayRequest<AlipayCommerceEducateXuexinIdentityQueryResponse> {
	...
	* 支付宝标准用户学信网在校信息授权查询
	...
	public Class<AlipayCommerceEducateXuexinIdentityQueryResponse> getResponseClass() {
		return AlipayCommerceEducateXuexinIdentityQueryResponse.class;
	}
