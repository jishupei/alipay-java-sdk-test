...
import com.alipay.api.domain.AlipayOpenAuthAppAesSetModel;
...
public class AlipayOpenAuthAppAesSetRequest implements AlipayRequest<AlipayOpenAuthAppAesSetResponse> {
	...
	* 授权应用aes密钥设置
	...
	public Class<AlipayOpenAuthAppAesSetResponse> getResponseClass() {
		return AlipayOpenAuthAppAesSetResponse.class;
	}
