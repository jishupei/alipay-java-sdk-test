...
import com.alipay.api.response.AlipayCommerceIotDapplyRefundCreateResponse;
...
public class AlipayCommerceIotDapplyRefundCreateRequest implements AlipayRequest<AlipayCommerceIotDapplyRefundCreateResponse> {
	...
	* 蚂蚁iot进件退货订单申请
	...
	public Class<AlipayCommerceIotDapplyRefundCreateResponse> getResponseClass() {
		return AlipayCommerceIotDapplyRefundCreateResponse.class;
	}
