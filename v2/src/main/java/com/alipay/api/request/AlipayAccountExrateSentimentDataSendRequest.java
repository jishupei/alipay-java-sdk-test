...
import com.alipay.api.response.AlipayAccountExrateSentimentDataSendResponse;
...
public class AlipayAccountExrateSentimentDataSendRequest implements AlipayRequest<AlipayAccountExrateSentimentDataSendResponse> {
	...
	* 国家制裁数据受理接口
	...
	public Class<AlipayAccountExrateSentimentDataSendResponse> getResponseClass() {
		return AlipayAccountExrateSentimentDataSendResponse.class;
	}
