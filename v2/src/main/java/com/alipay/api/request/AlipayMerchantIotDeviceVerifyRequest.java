 ...
 */
public class AlipayMerchantIotDeviceVerifyRequest implements AlipayRequest<AlipayMerchantIotDeviceVerifyResponse> {
	...
	* IoT设备、商户绑定校验
	...
	public Class<AlipayMerchantIotDeviceVerifyResponse> getResponseClass() {
		return AlipayMerchantIotDeviceVerifyResponse.class;
	}
