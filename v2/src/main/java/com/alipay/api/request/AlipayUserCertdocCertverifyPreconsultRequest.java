...
import com.alipay.api.domain.AlipayUserCertdocCertverifyPreconsultModel;
...
public class AlipayUserCertdocCertverifyPreconsultRequest implements AlipayRequest<AlipayUserCertdocCertverifyPreconsultResponse> {
	...
	* 实名证件信息比对验证预咨询
	...
	public Class<AlipayUserCertdocCertverifyPreconsultResponse> getResponseClass() {
		return AlipayUserCertdocCertverifyPreconsultResponse.class;
	}
