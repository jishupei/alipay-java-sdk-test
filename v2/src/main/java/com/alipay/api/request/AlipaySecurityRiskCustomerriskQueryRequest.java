...
import com.alipay.api.domain.AlipaySecurityRiskCustomerriskQueryModel;
...
public class AlipaySecurityRiskCustomerriskQueryRequest implements AlipayRequest<AlipaySecurityRiskCustomerriskQueryResponse> {
	...
	* 商户风险服务输出
	...
	public Class<AlipaySecurityRiskCustomerriskQueryResponse> getResponseClass() {
		return AlipaySecurityRiskCustomerriskQueryResponse.class;
	}
