 ...
 */
public class AlipayOpenAppMiniTemplatemessageSendRequest implements AlipayRequest<AlipayOpenAppMiniTemplatemessageSendResponse> {
	...
	* 小程序发送模板消息
	...
	public Class<AlipayOpenAppMiniTemplatemessageSendResponse> getResponseClass() {
		return AlipayOpenAppMiniTemplatemessageSendResponse.class;
	}
