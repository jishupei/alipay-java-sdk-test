...
import com.alipay.api.response.AlipaySecurityProdCtidVerifyResponse;
...
public class AlipaySecurityProdCtidVerifyRequest implements AlipayRequest<AlipaySecurityProdCtidVerifyResponse> {
	...
	* 网证验证接口
	...
	public Class<AlipaySecurityProdCtidVerifyResponse> getResponseClass() {
		return AlipaySecurityProdCtidVerifyResponse.class;
	}
