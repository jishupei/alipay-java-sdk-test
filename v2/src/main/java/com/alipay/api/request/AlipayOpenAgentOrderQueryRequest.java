 ...
 */
public class AlipayOpenAgentOrderQueryRequest implements AlipayRequest<AlipayOpenAgentOrderQueryResponse> {
	...
	* 查询申请单状态
	...
	public Class<AlipayOpenAgentOrderQueryResponse> getResponseClass() {
		return AlipayOpenAgentOrderQueryResponse.class;
	}
