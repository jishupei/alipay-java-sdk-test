 ...
 */
public class AlipayDataBillBalanceQueryRequest implements AlipayRequest<AlipayDataBillBalanceQueryResponse> {
	...
	* 支付宝商家账户当前余额查询
	...
	public Class<AlipayDataBillBalanceQueryResponse> getResponseClass() {
		return AlipayDataBillBalanceQueryResponse.class;
	}
