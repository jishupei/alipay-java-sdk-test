...
import com.alipay.api.response.AlipayInsCooperationRegionQrcodeApplyResponse;
...
public class AlipayInsCooperationRegionQrcodeApplyRequest implements AlipayRequest<AlipayInsCooperationRegionQrcodeApplyResponse> {
	...
	* （快捷投保）生成专区二维码
	...
	public Class<AlipayInsCooperationRegionQrcodeApplyResponse> getResponseClass() {
		return AlipayInsCooperationRegionQrcodeApplyResponse.class;
	}
