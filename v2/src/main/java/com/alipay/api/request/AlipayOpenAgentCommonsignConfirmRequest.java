...
import com.alipay.api.domain.AlipayOpenAgentCommonsignConfirmModel;
...
public class AlipayOpenAgentCommonsignConfirmRequest implements AlipayRequest<AlipayOpenAgentCommonsignConfirmResponse> {
	...
	* 代商户签约，提交信息确认接口
	...
	public Class<AlipayOpenAgentCommonsignConfirmResponse> getResponseClass() {
		return AlipayOpenAgentCommonsignConfirmResponse.class;
	}
