 ...
 */
public class AlipayOpenMiniVersionOnlineRequest implements AlipayRequest<AlipayOpenMiniVersionOnlineResponse> {
	...
	* 小程序上架
	...
	public Class<AlipayOpenMiniVersionOnlineResponse> getResponseClass() {
		return AlipayOpenMiniVersionOnlineResponse.class;
	}
