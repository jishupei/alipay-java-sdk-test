 ...
 */
public class ZolozAuthenticationCustomerFtokenQueryRequest implements AlipayRequest<ZolozAuthenticationCustomerFtokenQueryResponse> {
	...
	* 人脸ftoken查询消费接口
	...
	public Class<ZolozAuthenticationCustomerFtokenQueryResponse> getResponseClass() {
		return ZolozAuthenticationCustomerFtokenQueryResponse.class;
	}
