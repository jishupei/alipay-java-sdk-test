...
import com.alipay.api.response.MybankCreditSupplychainTradeCancelResponse;
...
public class MybankCreditSupplychainTradeCancelRequest implements AlipayRequest<MybankCreditSupplychainTradeCancelResponse> {
	...
	* 交易取消
	...
	public Class<MybankCreditSupplychainTradeCancelResponse> getResponseClass() {
		return MybankCreditSupplychainTradeCancelResponse.class;
	}
