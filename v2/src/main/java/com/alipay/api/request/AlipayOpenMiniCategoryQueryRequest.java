 ...
 */
public class AlipayOpenMiniCategoryQueryRequest implements AlipayRequest<AlipayOpenMiniCategoryQueryResponse> {
	...
	* 小程序类目树查询
	...
	public Class<AlipayOpenMiniCategoryQueryResponse> getResponseClass() {
		return AlipayOpenMiniCategoryQueryResponse.class;
	}
