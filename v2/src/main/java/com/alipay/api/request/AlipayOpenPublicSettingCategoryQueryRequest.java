...
import com.alipay.api.response.AlipayOpenPublicSettingCategoryQueryResponse;
...
public class AlipayOpenPublicSettingCategoryQueryRequest implements AlipayRequest<AlipayOpenPublicSettingCategoryQueryResponse> {
	...
	public Class<AlipayOpenPublicSettingCategoryQueryResponse> getResponseClass() {
		return AlipayOpenPublicSettingCategoryQueryResponse.class;
	}
