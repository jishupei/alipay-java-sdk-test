...
import com.alipay.api.response.AnttechBlockchainFinanceFileUploadResponse;
...
public class AnttechBlockchainFinanceFileUploadRequest implements AlipayUploadRequest<AnttechBlockchainFinanceFileUploadResponse> {
	...
	* 文件类型
	...
	public Map<String, String> getTextParams() {		
		...
		txtParams.put("other_param", this.otherParam);
		if(udfParams != null) {
	...
	public Class<AnttechBlockchainFinanceFileUploadResponse> getResponseClass() {
		return AnttechBlockchainFinanceFileUploadResponse.class;
	}
